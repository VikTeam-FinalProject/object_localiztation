...
from dinov2_old.data import make_dataset
from dinov2_old.data.transforms import make_classification_eval_transform
from dinov2_old.distributed import get_global_rank, get_global_size
...
from dinov2_old.eval.utils import evaluate, extract_features
from dinov2_old.utils.dtype import as_torch_dtype
