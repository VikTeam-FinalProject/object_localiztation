...
from dinov2_old.loss import DINOLoss, iBOTPatchLoss, KoLeoLoss
from dinov2_old.models import build_model_from_cfg
from dinov2_old.layers import DINOHead
from dinov2_old.utils.utils import has_batchnorms
from dinov2_old.utils.param_groups import get_params_groups_with_decay, fuse_params_groups
from dinov2_old.fsdp import get_fsdp_wrapper, ShardedGradScaler, get_fsdp_modules, reshard_fsdp_model

from dinov2_old.models.vision_transformer import BlockChunk
...
class SSLMetaArch(nn.Module):
    ...
    def fsdp_synchronize_streams(self):
        ...
        # attach a common stream reference instead of _streams
            self.student.dino_head.stream = stream
            self.teacher.dino_head.stream = stream
            self.student.backbone.stream = stream
            self.teacher.backbone.stream = stream
