# https://github.com/valeoai/LOST/blob/master/object_discovery.py#L60
...
if __name__ == "__main__":
    ...
    feat_sample = torch.rand(1, 100, 150 )
    # batch, w*h, dim
    dims = (100, 100)
    scales = (1, 1)
    init_image_size = (100, 100)

    print('shape of feat: ', feat_sample.shape)
    A  = (feat_sample @ feat_sample.transpose(1, 2)).squeeze()
    print('shape of A: ', A.shape)

    sorted_patches, scores = patch_scoring(A)
    print('shape of sorted_patches: ', sorted_patches.shape)