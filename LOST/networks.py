...
def get_model(arch, patch_size, resnet_dilate, device):
    ...
    elif "dinov2_vitb14_reg4_pretrain" in arch:
        model = vit_base(patch_size=14, img_size=526,
                          init_values=1.0,
                          block_chunks=0,
    ...
    elif "dinov2_vits14_reg4_pretrain" in arch:
        model = vit_small(patch_size=14,
                          img_size=526,
                          init_values=1.0,
                          block_chunks=0,
    ...
    elif "dinov2_vitg14_reg4_pretrain" in arch:
        pass
    else:
    ...
    if "imagenet" not in arch:
        ...
        if arch == "vit_small" and patch_size == 16:
            ...
            if "dinov2_vitg14_reg4_pretrain" in arch:
                print("call")
